...
import com.diegomillan.cursomc.repositories.*;
...
public class DBService {
    ...
    public void instantiateDatabase() throws ParseException {
        ...
        Pedido ped1 = new Pedido(null, sdf.parse("30/09/207 10:32"), cli1, e1);
        Pedido ped2 = new Pedido(null, sdf.parse("10/10/207 19:32"), cli1, e2);
